...
class BaseCCPFileResponse(TeaModel):
    ...
    def __init__(self, category=None, content_hash=None, content_hash_name=None, content_type=None, crc_64hash=None,
                 ...
                 parent_file_id=None, size=None, starred=None, status=None, streams_info=None, thumbnail=None, trashed_at=None,
                 type=None, updated_at=None, upload_id=None, url=None, user_meta=None, video_media_metadata=None,
...
class GetStoryDetailResponse(TeaModel):
    ...
    def __init__(self, cover_file_id=None, created_at=None, score=None, story_id=None, story_images_date_range=None,
                 sub_title=None, title=None, updated_at=None, video_status=None, video_url=None, items=None):
        # cover_file_id
