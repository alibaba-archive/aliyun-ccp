 ...
 * 根据路径获取文件元数据response
 */
public class CCPGetFileByPathResponse extends TeaModel {
    @NameInMap("category")
    ...
    public static CCPGetFileByPathResponse build(java.util.Map<String, ?> map) throws Exception {
        CCPGetFileByPathResponse self = new CCPGetFileByPathResponse();
